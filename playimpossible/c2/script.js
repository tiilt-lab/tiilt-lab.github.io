...
async function startListening(device) {
    ...
    ///// 132/133 SUPER SENSITIVE!!
    var a1Chars = await startAccel("accel1", Uint8Array.of(0x197), Uint16Array.of(138), server);
    await startAccel("accel2", Uint8Array.of(0x647), Uint16Array.of(138), server);
...
async function handleDataChange(event) {
  ...
  x = tba[1] * 0.0008; y = tba[1] * 0.0008; z = tba[2] * 0.0008;
